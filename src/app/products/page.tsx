...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/images/products/luxury-packaging/luxury-packaging-range-v5.webp`,
        width: 1200,
        height: 900,
  ...
  twitter: {
    ...
    images: [
      `${siteUrl}/images/products/luxury-packaging/luxury-packaging-range-v5.webp`,
    ],
  },
  robots: {
    index: true,
            ...
            <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-5 shadow-2xl shadow-cyan-950/40">
                <div className="relative aspect-[4/3] overflow-hidden rounded-[1.5rem] bg-[#EDE5DC]">
                  <Image
                    src="/images/products/luxury-packaging/luxury-packaging-range-v5.webp"
