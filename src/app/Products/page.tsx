...
export const metadata: Metadata = {
  ...
  description:
    "Explore custom packaging products including rigid boxes, folding cartons, mailer boxes, butter paper, food packaging, paper bags, labels and luxury packaging.",
  alternates: {
