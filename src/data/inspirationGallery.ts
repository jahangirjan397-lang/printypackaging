...
export const inspirationGallery: InspirationImage[] = [
  ...
  { src: "/images/inspiration/carton-10.webp", label: "Foil tuck end boxes", category: "retail", product: "tuck-end-boxes" },
  { src: "/images/inspiration/carton-14.webp", label: "Card boxes with die-cut windows", category: "retail", product: "tuck-end-boxes" },
  { src: "/images/inspiration/carton-8.webp", label: "Retail tuck end carton set", category: "retail", product: "tuck-end-boxes" },
  { src: "/images/inspiration/carton-b4-1.webp", label: "Hang tab box", category: "retail", product: "hang-tab-boxes" },
  { src: "/images/inspiration/carton-b4-2.webp", label: "Plain hang tab boxes", category: "retail", product: "hang-tab-boxes" },
  { src: "/images/inspiration/carton-b4-4.webp", label: "Tall hang tab box", category: "retail", product: "hang-tab-boxes" },
  { src: "/images/inspiration/carton-b4-11.webp", label: "Printed tuck carton, flat", category: "retail", product: "tuck-end-boxes" },
  { src: "/images/inspiration/carton-b4-12.webp", label: "Printed tuck end boxes", category: "retail", product: "tuck-end-boxes" },
  { src: "/images/inspiration/carton-b4-13.webp", label: "Kraft tuck top gift box", category: "retail", product: "kraft-boxes" },
